...
public class JoystickEditor : Editor
{
    ...
    private SerializedProperty alwaysHide;
    ...
    protected virtual void OnEnable()
    {
        ...
        alwaysHide = serializedObject.FindProperty("alwaysHide");
    ...
    protected virtual void DrawValues()
    {
        ...
        EditorGUILayout.PropertyField(alwaysHide, new GUIContent("AlwaysHide", "Joystick will be always hide."));
    }
